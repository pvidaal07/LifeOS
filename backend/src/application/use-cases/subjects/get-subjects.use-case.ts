...
import { SubjectRepositoryPort, SubjectWithRelations } from '../../ports/subject-repository.port';

export class GetSubjectsUseCase {
  constructor(private readonly subjectRepo: SubjectRepositoryPort) {}

  async execute(planId: string, userId: string): Promise<SubjectWithRelations[]> {
