...
export class CompleteReviewDto {
  @ApiProperty({
    ...
    description: 'Resultado del repaso: perfect (no necesité pensar), good (bien), regular (con dudas), bad (no recordaba)',
  })
  @IsString()
  ...
  @ApiPropertyOptional({ minimum: 1, maximum: 5, description: 'Calidad de la sesión (1-5)' })
  @IsOptional()
  @IsInt()
  @Min(1)
  @Max(5)
